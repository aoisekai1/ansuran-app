    ...
    listMenu(){
        ...
        if(userinfo.isCustomer){
            return(<>
                ...
                <li><Link className="nav-link scrollto" to="/register">Gempa Bumi</Link></li>
                <li><Link className="nav-link scrollto" to="/login">Kendaraan Bermotor</Link></li>
                <li><Link className="nav-link scrollto" to="/register">Kecelakaan Diri</Link></li>
                <li><Link className="nav-link scrollto" to="/login">Kesehatan</Link></li>
